...
public class ContratRestController {
	...
	// http://localhost:8082/contrat/retrieve-all-contrats
	...
	// http://localhost:8082/contrat/retrieve-contrat/{id}
	@GetMapping("/retrieve-contrat/{contrat-id}")
	public Contrat retrieveContrat(@PathVariable("contrat-id") Integer contratId) {
		return contratService.retrieveContrat(contratId);
	}

	// http://localhost:8082/contrat/add-contrat
	...
	// http://localhost:8082/contrat/remove-contrat/{id}
	@DeleteMapping("/remove-contrat/{contrat-id}")
	public void removeContrat(@PathVariable("contrat-id") Integer contratId) {
		contratService.removeContrat(contratId);
	}

	// http://localhost:8082/contrat/update-contrat
	 ...
	 * public Contrat assignContratToEtudiant (Contrat ce, String nomE, String
	 * prenomE){
