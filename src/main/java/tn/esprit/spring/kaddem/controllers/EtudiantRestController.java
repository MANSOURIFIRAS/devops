...
public class EtudiantRestController {
	...
	// http://localhost:8082/etudiant/retrieve-all-etudiants
	...
	// http://localhost:8082/etudiant/remove-etudiant/{id}
	@DeleteMapping("/remove-etudiant/{etudiant-id}")
	public void removeEtudiant(@PathVariable("etudiant-id") Integer etudiantId) {
		etudiantService.removeEtudiant(etudiantId);
	}

	// http://localhost:8082/etudiant/update-etudiant
	...
	// addAndAssignEtudiantToEquipeAndContract(Etudiant e, Integer idContrat,
	// Integer idEquipe)
